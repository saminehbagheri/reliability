...
from reliability_extension.Nonparametric import KaplanMeier, NelsonAalen, RankAdjustment
    ...
    if show_fitted_distribution is True:
        ...
        if fit_gamma is False:
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Weibull_2P
            ...
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Weibull_3P
    ...
    if show_fitted_distribution is True:
        ...
        if fit_gamma is False:
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Loglogistic_2P
            ...
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Loglogistic_3P
    ...
    if show_fitted_distribution is True:
        ...
        if fit_gamma is False:
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Exponential_1P
            ...
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Exponential_2P
    ...
    **kwargs
    ...
    if show_fitted_distribution is True:
        ...
        if __fitted_dist_params is not None:
            ...
            from reliability_extension.Fitters import Fit_Gumbel_2P
    ...
    **kwargs
    ...
    if show_fitted_distribution is True:
        ...
        if __fitted_dist_params is not None:
            ...
            from reliability_extension.Fitters import Fit_Normal_2P
    ...
    if show_fitted_distribution is True:
        ...
        if fit_gamma is False:
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Lognormal_2P
            ...
            if __fitted_dist_params is not None:
                ...
                from reliability_extension.Fitters import Fit_Lognormal_3P
...
def Beta_probability_plot(
    ...
    **kwargs
    ...
    if __fitted_dist_params is not None:
        ...
        from reliability_extension.Fitters import Fit_Beta_2P
    ...
    **kwargs
    ...
    if fit_gamma is False:
        if __fitted_dist_params is not None:
            ...
            from reliability_extension.Fitters import Fit_Gamma_2P
        ...
        if __fitted_dist_params is not None:
            ...
            from reliability_extension.Fitters import Fit_Gamma_3P
